...
**📌 API Evolution Note:** This endpoint uses an unversioned path structure (`/network/...`). For OWL cameras, there is a versioned equivalent: [Set OWL Thumbnail (v1)](../../v1/accounts/set-owl-thumbnail.md) (`POST /api/v1/accounts/{AccountID}/networks/{NetworkID}/owls/{CameraID}/thumbnail`). The unversioned path structure represents an earlier API design that evolved alongside the versioned structure. See [Version Compatibility Report](../../plan/COMPATIBILITY_REPORT.md) for details.
...
**Notes:**
- This endpoint uses an unversioned path structure that evolved alongside the versioned API
- This endpoint is for regular cameras (not OWL cameras)
- For OWL cameras, use the versioned endpoint: [Set OWL Thumbnail (v1)](../../v1/accounts/set-owl-thumbnail.md)
- This call is asynchronous and returns a command object that should be polled using [Command Status](../command.md)
...
**See also:**
- [Set OWL Thumbnail (v1)](../../v1/accounts/set-owl-thumbnail.md) - Versioned endpoint for OWL cameras
- [Version Compatibility Report](../../plan/COMPATIBILITY_REPORT.md) - Compatibility testing results
